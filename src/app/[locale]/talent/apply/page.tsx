...
import { TalentApplicationForm } from '@/components/sections/talent-apply/TalentApplicationForm';
...
export default async function TalentApplyPage({
  ...
  const t = await getTranslations('TalentApplyPage');
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
          ...
          <div className="relative border-x border-border/80">
            ...
            <div className="grid min-w-0 lg:grid-cols-[0.88fr_1.12fr] lg:divide-x lg:divide-border/80">
              <div className="min-w-0 px-5 py-12 sm:px-8 md:py-16 lg:px-10 lg:py-20">
                ...
                <h1 className="mt-7 max-w-lg break-words font-heading text-5xl leading-[0.94] font-semibold tracking-[-0.045em] text-balance text-foreground hyphens-auto sm:text-6xl lg:text-7xl">
                  {t('hero.title')}
                </h1>
      ...
      <SectionWrapper
        ...
        aria-labelledby="application-process"
      >
